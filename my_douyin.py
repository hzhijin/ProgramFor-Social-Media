...
options.add_argument("user-data-dir=C:\\Users\\ThinkPad-X200\\AppData\\Local\\Google\\Chrome\\User Data1") #Path to your chrome profile
...
while True:
	...
	df = pd.read_excel(r'C:\D\youget\douyin_list.xlsx')
